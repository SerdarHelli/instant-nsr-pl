...
def save_images(object_file: str, viewidx: int) -> None:
    ...
    os.makedirs(os.path.join(args.output_folder, object_uid,"camera"), exist_ok=True)
    os.makedirs(os.path.join(args.output_folder, object_uid,"image"), exist_ok=True)
    os.makedirs(os.path.join(args.output_folder, object_uid,"normal"), exist_ok=True)
